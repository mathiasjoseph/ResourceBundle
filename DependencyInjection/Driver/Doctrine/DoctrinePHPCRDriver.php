...
use Miky\Bundle\ResourceBundle\Doctrine\ODM\PHPCR\EventListener\DefaultParentListener;
use Miky\Bundle\ResourceBundle\Doctrine\ODM\PHPCR\EventListener\NameFilterListener;
use Miky\Bundle\ResourceBundle\Doctrine\ODM\PHPCR\EventListener\NameResolverListener;
use Miky\Bundle\ResourceBundle\Doctrine\ODM\PHPCR\Form\Builder\DefaultFormBuilder;
use Miky\Bundle\ResourceBundle\Form\Type\DefaultResourceType;
use Miky\Component\Resource\Metadata\MetadataInterface;
use Miky\Component\Resource\Repository\TranslatableRepositoryInterface;
...
class DoctrinePHPCRDriver extends AbstractDoctrineDriver
{
    ...
    {
        return MikyResourceBundle::DRIVER_DOCTRINE_PHPCR_ODM;
    }
